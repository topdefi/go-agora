...
// Package gethclient provides an RPC client for agora-specific APIs.
package gethclient
...
// Client is a wrapper around rpc.Client that implements agora-specific functionality.
//
...
// GCStats retrieves the current garbage collection stats from a agora node.
...
// MemStats retrieves the current memory stats from a agora node.
...
// GetNodeInfo retrieves the node info of a agora node.
