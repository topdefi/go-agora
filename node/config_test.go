...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "agora.ipc", false, filepath.Join(os.TempDir(), "agora.ipc")},
		{"data", "agora.ipc", false, "data/agora.ipc"},
		{"data", "./agora.ipc", false, "./agora.ipc"},
		{"data", "/agora.ipc", false, "/agora.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "agora.ipc", true, `\\.\pipe\agora.ipc`},
		{"data", "agora.ipc", true, `\\.\pipe\agora.ipc`},
		{"data", `\\.\pipe\agora.ipc`, true, `\\.\pipe\agora.ipc`},
	}
