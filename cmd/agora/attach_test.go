...
// TestAttachWithHeaders tests that 'agora attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'agora db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
