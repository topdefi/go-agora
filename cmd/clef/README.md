...
In this case, `agora` would be started with `--signer http://localhost:8550` and would relay requests to `eth.sendTransaction`.
...
* Geth todos
    ...
    - Relay: Geth should be started in `agora --signer localhost:8550`.
