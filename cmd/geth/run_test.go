...
func init() {
	// Run the app if we've been exec'd as "agora-test" in runGeth.
	reexec.Register("agora-test", func() {
...
// spawns agora with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "agora". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("agora-test", args...)
